...
CREATE TABLE `bed` (
  ...
  `Mattress` enum('YES','NO') DEFAULT NULL,
  PRIMARY KEY (`ID_Bed`),
...
INSERT INTO `bed` VALUES (1,4,'Dog','Orthopedic','M','YES'),(2,6,'Cat','wicker basket','M','NO'),(3,4,'Dog','Hard_matress','M','NO'),(4,3,'Dog','Orthopedic','M','NO'),(5,6,'Dog','Outdoor','L','YES'),(6,3,'Cat','plastic basket','M','YES'),(7,8,'Cat','cat igloo','L','YES'),(8,3,'Dog','Hard_matress','M','NO'),(9,4,'Cat','cat hammocks','M','YES'),(10,5,'Cat','cat hammocks','M','NO'),(11,4,'Dog','Heated','M','NO'),(12,8,'Cat','cat igloo','L','YES'),(13,9,'Dog','Hammock','S','YES'),(14,4,'Cat','donut cat','S','NO'),(15,4,'Cat','Outdoor','L','YES'),(16,7,'Dog','cat igloo','M','YES'),(17,2,'Dog','Hammock','S','NO'),(23,5,'Dog','Hardmatress','M','YES');
/*!40000 ALTER TABLE `bed` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `bedinf`
--

DROP TABLE IF EXISTS `bedinf`;
/*!50001 DROP VIEW IF EXISTS `bedinf`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `bedinf` AS SELECT 
 1 AS `Species`,
 1 AS `ID_Bed`,
 1 AS `ID_Room`*/;
...
INSERT INTO `employee` VALUES ('EI387715','Caretaker',5,'Training','Jack','Daniel','546867217','6954283751','Estrella 7','ken_biral@gmail.com','YES'),('EY093712','Animal Trainer',20,'MarineMammals','Mike','Alan','564546202','6932300585','Bronx 114','krikri@yahoo.com','YES'),('IA784323','Animal Trainer',30,'Veterinarian','Dan','Notariem','977834251','6934382145','Heraklus 83','leoforos13@windowslive.com','NO'),('IA828492','Animal Trainer',13,'AnimalBehavioral','John','Savatzer','214595763','6977477511','Ontarel 80','righthat@yahoo.com','NO'),('IO822544','Animal Trainer',25,'AnimalBehavioral','Alex','Clifford','258969841','6977833545','Malakasa 23','kones@hotmail.com','YES'),('KI946839','Caretaker',14,'Veterinarian','Jeremy','Walker','589965256','6956196384','Onirtha 6','everythingisnotok@gmail.com','YES'),('MN569167','Cleaner',12,'OdorsDisappear','Derek','Walker','859765837','6957765728','Katerian 45','geogr_yo@yahoo.com','NO'),('NO582814','Cleaner',11,'OdorsDisappear','Pat','Patanakis','852301471','6983172319','Montreal 1','canastel@gmail.com','YES'),('OE562829','Cleaner',10,'OdorsDisappear','Ivan','Crouz','343147890','6977866396','Latern 7','crazer@gmail.com','NO'),('OK563292','Caretaker',6,'Vaccines/euthanize','Nick','Drinkwater','345467998','6978512151','Manhatan 285','osterl@windowslive.com','YES'),('PH564238','Caretaker',3,'Training','George','Fanoler','778400495','6962282154','Gaziella 81','sol_pason@gmail.com','NO'),('PP658023','Caretaker',7,'PetGroomer','Max','Jerenal','938626784','6971365325','Saint Marin 13','tifozi@gmail.com','YES'),('TO222938','Caretaker',8,'Exercise','George','Octapus','785455112','6973351245','Peramor 11','killahPir@gmail.com','NO'),('YT487234','Animal Trainer',15,'GuideDogs','Anty','Smith','564349582','6943375733','Olympoy 1','perieyn@windowslive.com','NO');
...
CREATE TABLE `pet` (
  ...
  `ATOwner` varchar(25) NOT NULL,
  `Sterilization` enum('YES','NO') DEFAULT NULL,
  PRIMARY KEY (`ID_Pet`),
...
INSERT INTO `pet` VALUES (1,'yorkshire terrier','Rex','Dog',2.000,5.550,'Grey',1,'TY487240','NO'),(2,'Russian Blue','Mike','Cat',4.000,4.600,'Black',2,'NM569123','NO'),(3,'Labrador Retriever','Doggo','Dog',10.000,9.500,'Brown',3,'EP658023','YES'),(4,'Pug','Puppie','Dog',4.000,4.300,'White',4,'HK473292','NO'),(5,'Dachshund','Moly','Dog',8.000,9.100,'Grey',5,'YE093212','YES'),(6,'Persian','Holy','Cat',2.000,4.300,'Brown',6,'OI392544','YES'),(7,'Siamese','Greg','Cat',6.000,7.500,'White',7,'KE563829','YES'),(8,'Poodle','Ivan','Dog',6.000,5.600,'Black',8,'OA628492','YES'),(9,'Munchin','Hermiony','Cat',9.000,7.100,'Black',9,'TI102938','YES'),(10,'Maine Coon','Pat','Cat',3.000,6.500,'Grey',10,'PO564738','NO'),(11,'German Sepherd','Max','Dog',5.000,6.700,'White',11,'HA784523','NO'),(12,'Ragdoll','Alex','Cat',2.000,9.300,'Brown',12,'PI384715','YES'),(13,'Dobermann','Scandal','Dog',1.000,1.500,'Yellow',13,'HO542814','YES'),(14,'Himalayan','Garfield','Cat',8.000,4.900,'White',14,'HI941839','YES');
...
INSERT INTO `petowner` VALUES ('EP658023',1,'Dan','Smoth','938625024','6973365325','Saint Marin 23','papifi@gmail.com','YES'),('HA784523',8,'Eki','Gonzales','977841451','6932782145','Heraklus 81','leoforos@windowslive.com','YES'),('HI941839',4,'Alex','Katralex','589128256','6979196384','Onirtha 69','everything@gmail.com','NO'),('HK473292',1,'Eric','Smith','345486998','6978512141','Manhatan 2','boriza_kratos@windowslive.com','NO'),('HO542814',1,'Mike','Cohones','852369471','6981572319','Montreal 8','canada_rules@gmail.com','YES'),('KE563829',1,'Dani','Alves','343567890','6977852396','Latern 72','crazy_player@gmail.com','YES'),('NM569123',13,'George','Geran','859305837','6954765728','Katerian 43','geor_anty@yahoo.com','NO'),('OA628492',1,'Nick','Cave','214578963','6977454511','Ontarel 8','right_red_hat@yahoo.com','NO'),('OI392544',7,'Mike','Konak','258963741','6977845545','Malakasa 33','konaki_koupes@hotmail.com','NO'),('PI384715',10,'Ken','Barbos','548963217','6953483751','Estrella 57','ken_barbie@gmail.com','YES'),('PO564738',16,'Jennaro','Gattuso','778452895','6965782154','Gaziella 65','solo_passion@gmail.com','NO'),('TI102938',3,'Rambo','Stallone','787845112','6978451245','Peramor 112','killer@gmail.com','YES'),('TY487240',2,'Nick','Greaker','564729582','6943375732','Olympoy 19','perMan@windowslive.com','NO'),('YE093212',6,'John','Staham','564839202','6932325585','Bronx 115','praktor@yahoo.com','NO');
...
--
-- Temporary view structure for view `roominf`
--

DROP TABLE IF EXISTS `roominf`;
/*!50001 DROP VIEW IF EXISTS `roominf`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `roominf` AS SELECT 
 1 AS `ID_Room`,
 1 AS `RoomName`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `roomsandpetsandbeds`
--

DROP TABLE IF EXISTS `roomsandpetsandbeds`;
/*!50001 DROP VIEW IF EXISTS `roomsandpetsandbeds`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `roomsandpetsandbeds` AS SELECT 
 1 AS `idRoom`,
 1 AS `RoomName`,
 1 AS `id_bed`,
 1 AS `petSpecies`,
...
--
-- Final view structure for view `bedinf`
--
...
/*!50001 VIEW `bedinf` AS select `bed`.`Species` AS `Species`,`bed`.`ID_Bed` AS `ID_Bed`,`bed`.`ID_Room` AS `ID_Room` from `bed` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `bedsandrooms` AS select `t1`.`ID_Room` AS `idRoom`,`t2`.`RoomName` AS `RoomName`,`t1`.`ID_Bed` AS `id_bed`,`t1`.`Species` AS `petSpecies` from (`bedinf` `t1` join `roominf` `t2` on((`t1`.`ID_Room` = `t2`.`ID_Room`))) order by `t1`.`ID_Room` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `emptybeds` AS select `roomsandpetsandbeds`.`idRoom` AS `idRoom`,`roomsandpetsandbeds`.`RoomName` AS `RoomName`,`roomsandpetsandbeds`.`id_bed` AS `id_bed`,`roomsandpetsandbeds`.`petSpecies` AS `petSpecies` from `roomsandpetsandbeds` where isnull(`roomsandpetsandbeds`.`ID_Pet`) order by `roomsandpetsandbeds`.`idRoom`,`roomsandpetsandbeds`.`id_bed` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `roominf`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `roominf` AS select `room`.`ID_Room` AS `ID_Room`,`room`.`RoomName` AS `RoomName` from `room` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `roomsandpetsandbeds`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `roomsandpetsandbeds` AS select `bedsandrooms`.`idRoom` AS `idRoom`,`bedsandrooms`.`RoomName` AS `RoomName`,`bedsandrooms`.`id_bed` AS `id_bed`,`bedsandrooms`.`petSpecies` AS `petSpecies`,`pet`.`ID_Pet` AS `ID_Pet` from (`bedsandrooms` left join `pet` on((`bedsandrooms`.`id_bed` = `pet`.`ID_Bed`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-01-08 13:06:20
